    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="abstand">
                ...
                <div class="profile-img"><img id="user_img" src="bilder/default-user-profile-picture-3.png" alt="Profilbild">
                </div>
            ...
            <div class="abstand">
                <div class="feed">
                    ...
                    <div id="alle_beitraege">
                        <iframe src="alle_beitraege.php" height="500" scrolling="yes" width="500" class="beitraege_iframe"></iframe>
                        <!--
